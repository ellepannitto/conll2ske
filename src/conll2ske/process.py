...
def transform_conllu_to_vert(input_file, output_file) -> None:
    infile = open(input_file, 'r', encoding='utf-8') if input_file != "-" else sys.stdin
    outfile = open(output_file, 'w', encoding='utf-8') if output_file != "-" else sys.stdout
